                ...
                <div class="card overflow-hidden sm:rounded-md rounded-none">
                    <div class="p-6">
                        ...
                        <form class="form" action="<?php echo htmlspecialchars($_SERVER['REQUEST_URI']); ?>" method="POST">
                            <div class="mb-4">
                                <input required id="LoggingName" class="form-input" type="text" placeholder="Ingresa tu Nombre" autocomplete="off"  name="nombre">
                            </div>

                            <div class="mb-4">
                                <input id="LoggingEmailAddress" class="form-input" type="email" name="correo" placeholder="Ingresa tu Correo" required autocomplete="off">
                            </div>
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-center">Aun no tienes una Cuenta?<a href="register.html" class="text-primary ms-1"><b>Registrate</b></a></p>
                    </div>
                </div>
            </div>
        </div>
