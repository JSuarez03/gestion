    ...
    <div class="page-content">
      ...
      <main class="flex-grow p-6">
        ...
        <div class="flex flex-col gap-6">
          <div class="card">
            <div class="p-6">
              <form method="POST" action="<?php echo $_SERVER["REQUEST_URI"] ?>" class="grid lg:grid-cols-3 gap-6">
                <div>
                ...
                <div>
                  ...
                  <input type="text" id="simpleinput" name="apellido" class="form-input">
                </div>

                <div>
                  <label for="simpleinput" class="text-gray-800 text-sm font-medium inline-block mb-2">Cedula:</label>
                  <input type="text" id="simpleinput" name="cedula" class="form-input">
                </div>

                <div>
                  <label for="simpleinput" class="text-gray-800 text-sm font-medium inline-block mb-2">Numero de Telefono:</label>
                  <input type="tel" id="simpleinput" name="telefono" class="form-input">
                </div>

                <div>
                  <label for="simpleinput" class="text-gray-800 text-sm font-medium inline-block mb-2">Direccion:</label>
                  <input type="text" id="simpleinput" name="direccion" class="form-input">
                </div>

                <div class="col-span-3 text-center">
                  <button type="submit" class="btn bg-primary text-white hover:bg-blue-700" id="sweetalert-success">Registrar Cliente</button>
                </div>
