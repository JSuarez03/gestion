    ...
    <div class="page-content">
      ...
      <main class="flex-grow p-6">
        ...
        <div class="flex flex-col gap-6">
          <div class="card">
            <div class="p-6">
              <form method="POST" action="<?php echo PATH?>productos/completar" class="grid lg:grid-cols-3 gap-6">
                <div>
                  <label for="input-nombre" class="text-gray-800 text-sm font-medium inline-block mb-2">Nombre del Producto:</label>
                  <input type="text" id="input-nombre" class="form-input" name="nombre" value="<?php echo $producto['nombre_producto']; ?>">
                </div>

                <div>
                  <label for="input-descripcion" class="text-gray-800 text-sm font-medium inline-block mb-2">Descripcion:</label>
                  <input type="text" id="input-descripcion" class="form-input" name="descripcion" value="<?php echo $producto['descripcion']; ?>">
                </div>

                <div>
                  <label for="input-cantidad" class="text-gray-800 text-sm font-medium inline-block mb-2">Cantidad:</label>
                  <input type="number" id="input-cantidad" class="form-input" name="cantidad" value="<?php echo $producto['cantidad']; ?>">
                </div>

                <div>
                    <label for="input-precio" class="text-gray-800 text-sm font-medium inline-block mb-2">Precio:</label>
                    <input type="number" step="0.01" id="input-precio" class="form-input" name="precio" value="<?php echo $producto['precio_unitario']; ?>">
                </div>
                ...
                <div class="col-span-3 text-center">
                  <button type="submit" name="id_producto" value="<?php echo $producto['id_producto']?>" class="btn bg-primary text-white hover:bg-blue-700" id="sweetalert-success">Actualizar Producto</button>
                </div>
